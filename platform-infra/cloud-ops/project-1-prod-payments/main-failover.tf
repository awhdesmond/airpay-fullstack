...
module "subnet_gke" {
  ...
  subnet_primary_ip_cidr = "10.200.0.0/16"
  subnet_secondary_ip_cidrs = [
    { name = local.gke_cluster_pod_range_name, ip_cidr_range = "10.201.0.0/16" },
    { name = local.gke_cluster_svc_range_name, ip_cidr_range = "10.202.0.0/16" }
  ]
}
